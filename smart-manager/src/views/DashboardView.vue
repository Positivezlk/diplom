  ...
  <main class="app-shell">
    ...
    <section class="hero-panel">
      <div>
        ...
        <h2>Фокус на главном</h2>
        <span>Создавайте карточки, контролируйте дедлайны и меняйте статусы в один клик.</span>
      </div>
    ...
    <section class="workspace-panel">
      ...
      <div v-else-if="filteredTasks.length === 0" class="empty-state">
        ...
        <button class="button button-primary" type="button" @click="showCreate = true">Создать карточку</button>
      </div>
    ...
    <Transition name="modal-fade">
      <div v-if="showCreate" class="modal-backdrop" @click.self="showCreate = false">
        <form class="create-modal" @submit.prevent="addTask">
          ...
          <p class="eyebrow">Новая карточка</p>
    ...
    <button class="fab" type="button" aria-label="Создать карточку" @click="showCreate = true">+</button>
